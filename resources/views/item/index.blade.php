            ...
            <div class="row justify-content-between mb-2">
                ...
                @can(\App\Enums\PermissionEnum::create_item()->value)
                    <div class="col-auto ml-auto">
                        <a href="{{ url('/items/import') }}" class="btn btn-default">{{ __('Import') }}</a>
                    </div><!-- /.col -->
                    <div class="col-auto">
                        <a href="{{ url('/items/create') }}" class="btn btn-primary">{{ __('Create item') }}</a>
                    </div><!-- /.col -->
                @endcan
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ Request::fullUrlWithQuery([
                                                ...
                                                class="dropdown-item {{ Request::get('sort') == 'name' && Request::get('direction') == 'asc' ? 'active' : '' }}">{{ __('Name ascending') }}</a>
                                            <a href="{{ Request::fullUrlWithQuery([
                                                'sort' => 'name',
                                                'direction' => 'desc',
                                            ]) }}"
                                                class="dropdown-item {{ Request::get('sort') == 'name' && Request::get('direction') == 'desc' ? 'active' : '' }}">{{ __('Name descending') }}</a>
                                            <a href="{{ Request::fullUrlWithQuery([
                                                'sort' => 'price',
                                                'direction' => 'asc',
                                            ]) }}"
                                                class="dropdown-item {{ Request::get('sort') == 'price' && Request::get('direction') == 'asc' ? 'active' : '' }}">{{ __('Price ascending') }}</a>
                                            <a href="{{ Request::fullUrlWithQuery([
                                                'sort' => 'price',
                                                'direction' => 'desc',
                                            ]) }}"
                                                class="dropdown-item {{ Request::get('sort') == 'price' && Request::get('direction') == 'desc' ? 'active' : '' }}">{{ __('Price descending') }}</a>
                                            <a href="{{ Request::fullUrlWithQuery([
                                                'sort' => 'created_at',
                                                'direction' => 'asc',
                                            ]) }}"
                                                ...
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    @can(\App\Enums\PermissionEnum::delete_item()->value)
                                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                                            ...
                                                            data-action="{{ url('/items/' . $item->id) }}">{{ __('Delete') }}</button>
                                                    @endcan
                                                </div>
                                            </td>
                                        </tr>
