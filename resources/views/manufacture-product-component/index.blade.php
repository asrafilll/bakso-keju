                                ...
                                <div class="col-auto">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a
                                                href="{{ Request::fullUrlWithQuery([
                                                    'sort' => 'total_line_items_weight',
                                                    'direction' => 'asc',
                                                ]) }}"
                                                class="dropdown-item {{ Request::get('sort') == 'total_line_items_weight' && Request::get('direction') == 'asc' ? 'active' : '' }}"
                                            >{{ __('Total line items weight ascending') }}</a>
                                            <a
                                                href="{{ Request::fullUrlWithQuery([
                                                    'sort' => 'total_line_items_weight',
                                                    'direction' => 'desc',
                                                ]) }}"
                                                class="dropdown-item {{ Request::get('sort') == 'total_line_items_weight' && Request::get('direction') == 'desc' ? 'active' : '' }}"
                                            >{{ __('Total line items weight descending') }}</a>
                                            <a
                                                href="{{ Request::fullUrlWithQuery([
                            ...
                            <table class="table table-hover text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('Total line items weight') }} (gram)</th>
