    ...
    <div class="content-header">
        <div class="container">
            <div class="row justify-content-between mb-2">
                <div class="col-auto">
                    <h1 class="m-0">{{ __('Product component inventories') }}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                    ...
                    <div class="card">
                                    ...
                                    >
                                        <div class="input-group">
                                            ...
                                            <input
                                                ...
                                                placeholder="{{ __('Filter product component inventories') }}"
                                            />
                                        </div>
                                    </form>
                                </div>
                                                ...
                                                >
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="term">
                                                                <span>{{ __('Filter product component inventories') }}</span>
                                                            </label>
                                                            <input
                                                                type="search"
                                                                name="term"
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @forelse ($productComponentInventories as $productComponentInventory)
                                        <tr>
                                            <td class="align-middle">{{ $productComponentInventory->branch_name }}</td>
                                            <td class="align-middle">
                                                {{ $productComponentInventory->product_component_name }}</td>
                                            <td class="align-middle">{{ $productComponentInventory->quantity }}</td>
                                            <td class="align-middle">{{ $productComponentInventory->updated_at }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            {!! $productComponentInventories->withQueryString()->links() !!}
                        </div>
                    </div>
                </div>
            </div>
