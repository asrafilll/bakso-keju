    ...
    <div class="content-header">
        <div class="container">
            <div class="row justify-content-between mb-2">
                <div class="col-auto">
                    <h1 class="m-0">{{ __('Product inventories') }}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                                    ...
                                    >
                                        <div class="input-group">
                                            ...
                                            <input
                                                ...
                                                placeholder="{{ __('Filter product inventories') }}"
                                            />
                                        </div>
                                    </form>
                                </div>
                                                ...
                                                >
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="term">
                                                                <span>{{ __('Filter product inventories') }}</span>
                                                            </label>
                                                            <input
                                                                type="search"
                                                                name="term"
                                                            ...
                                                            var BranchModule = (function() {
                                                                ...
                                                                function init() {
                                                                    $branchId.select2({
                                                                        ...
                                                                        allowClear: true,
                                                                        ajax: {
                                                                            url: '/product-inventories?action=fetch-branches',
                                                                            dataType: 'json',
                                                                            delay: 250,
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @forelse ($productInventories as $productInventory)
                                        <tr>
                                            <td class="align-middle">{{ $productInventory->branch_name }}</td>
                                            <td class="align-middle">{{ $productInventory->product_name }}</td>
                                            <td class="align-middle">{{ $productInventory->quantity }}</td>
                                            <td class="align-middle">{{ $productInventory->updated_at }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            {!! $productInventories->withQueryString()->links() !!}
                        </div>
                    </div>
                </div>
            </div>
